    ...
    public User save(User entity) {
        if(!findUserByEmail(entity.getEmail()).isPresent()) {
            ...
            jdbcTemplate.update(connection -> {
                PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO person(name_of_user, email_of_user, password_of_user) values (?, ?, ?)", Statement.RETURN_GENERATED_KEYS);
